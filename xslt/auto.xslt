...
>
    ...
    >
            <xsl:for-each select="//activityinfo//team/member">
              ...
              ><xsl:apply-templates select="name" />: </fo:inline>
        ...
        />
              ...
              >
                ...
                />
                        ...
                        <xsl:otherwise>
                            <xsl:for-each
                select="$findingSummaryTable/findingEntry[matches(concat('//', string-join(findingLabel, '//')), concat('//', $match-labels))]"
              >
                                <xsl:call-template
                  name="findingsSummaryContent"
                />
    ...
    <xsl:template match="generate_recommendations">
        ...
        />
              ...
              >
                                <xsl:call-template
                  name="recommendationsSummaryContent"
                />
                            </xsl:for-each>
                        </xsl:when>
                        <xsl:when test="@status and not(@Ref)">
              ...
              >
                ...
                />
                        ...
                        <xsl:otherwise>
                            <xsl:for-each
                select="/pentest_report/descendant::finding"
              >
                                <xsl:call-template
                  name="recommendationsSummaryContent"
                />
    ...
    <xsl:template match="generate_testteam">
        ...
        />
                <fo:table-body>
                    <xsl:for-each
            select="/pentest_report/meta/collaborators/pentesters/pentester"
          >
                        <xsl:if
            ...
            >
                    ...
                    <xsl:for-each
            select="/pentest_report/meta/collaborators/approver"
          >
                        <fo:table-row xsl:use-attribute-sets="borders">
                            <fo:table-cell xsl:use-attribute-sets="td">
                                <fo:block>
    ...
    <xsl:template match="generate_permission_parties">
        <xsl:for-each
      select="/*/meta/permission_parties/client | /*/meta/permission_parties/party"
    >
    ...
    <xsl:template match="generate_service_breakdown">
        <xsl:choose>
            <xsl:when test="@format = 'list'">
                <fo:list-block xsl:use-attribute-sets="list">
                    <xsl:for-each
            select="$serviceNodeSet/entry[@type = 'service']"
          >
                        <xsl:if test="d">
                            <fo:list-item xsl:use-attribute-sets="li">
                                <!-- insert a bullet -->
            ...
            <xsl:when test="@format = 'table'">
                <fo:block xsl:use-attribute-sets="keep-together"><fo:table
            xsl:use-attribute-sets="breakdowntable"
          >
                    <fo:table-column
            ...
            />
                ...
                >
                                <fo:block xsl:use-attribute-sets="totalcell">
                                    ...
                                    <xsl:if
                      test="$serviceNodeSet/entry/@estimate = true()"
                    >
                                        (estimate)</xsl:if>
                                    <xsl:text>:</xsl:text>
